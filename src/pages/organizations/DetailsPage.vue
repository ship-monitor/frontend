<template>
    <div class="max-w-7xl mx-auto">
          ...
          >
            ...
            <div v-if="activeTab === 'devices'" class="space-y-4">
                ...
                <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                    <div v-for="dev in devices" class="flex flex-col gap-2 justify-between">
                        <DeviceCard :device-id="dev.id" />
                        <button @click.stop="confirmDisconnect(dev)"
        ...
        <Teleport to="body">
            <div v-if="showConnectDeviceModal"
                ...
                <div class="bg-white rounded-t-xl sm:rounded-xl p-5 sm:p-6 w-full sm:max-w-md">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">ID устройства (Node
                                ID)</label>
        ...
        <!-- Модалка: Приглашение -->
        <AddMemberModal v-if="organization" :show="showAddMemberModal" :close="() => (showAddMemberModal = false)"
