<template>
  <div class="p-8 max-w-5xl mx-auto">
    ...
    >
      <div class="bg-white rounded-lg p-6 w-lg max-h-[80vh] overflow-y-auto">
        <h2 class="text-xl font-bold mb-4">
        ...
        <div class="border-t pt-4 mt-4">
          ...
          <p v-if="membersError" class="text-red-500 text-sm mt-2">
            {{ membersError }}
          </p>
          <p v-if="membersSuccess" class="text-green-500 text-sm mt-2">
            {{ membersSuccess }}
          </p>
        </div>
...
const handleInviteMember = async () => {
  ...
  try {
    ...
    membersError.value =
      error.response?.data?.message || "Ошибка при приглашении";
  } finally {
