...
<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            ...
            <ship-textbox v-model="name" placeholder="Имя" name="name" class="mb-4" autocomplete="given-name" />
            <ship-textbox v-model="email" placeholder="Email" name="email" class="mb-4" autocomplete="email" />
            <ship-textbox v-model="password" placeholder="Password" name="password" type="password" class="mb-6"
