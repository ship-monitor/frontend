...
<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <form class="bg-white p-8 rounded-lg shadow-md w-96" @submit.prevent="handleLogin">
            <h1 class="text-2xl font-bold mb-6 text-center">Вход</h1>
            <ship-textbox v-model="form.email" placeholder="Email" name="email" class="mb-4" autocomplete="email" />
            <ship-textbox v-model="form.password" placeholder="Password" name="password" type="password" class="mb-6"
