  ...
  <div class="min-h-screen flex items-center justify-center p-6 bg-ink-50">
    <div class="ship-card p-8 sm:p-10 max-w-md w-full text-center animate-scale-in">
      ...
      <div v-if="loading" class="py-4">
        <svg class="w-7 h-7 text-brand-500 animate-spin mx-auto mb-4" fill="none" viewBox="0 0 24 24">
      ...
      <div v-else-if="success" class="py-4">
        <svg class="w-12 h-12 text-brand-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
